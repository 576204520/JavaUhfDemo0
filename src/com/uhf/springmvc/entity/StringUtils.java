...
public class StringUtils {
	...
	public static String getTimeFromMillisecond(Long millisecond) {
		String milli;
		long hours = millisecond / (60 * 60 * 1000); // 根据时间差来计算小时�?
		long minutes = (millisecond - hours * (60 * 60 * 1000)) / (60 * 1000); // 根据时间差来计算分钟�?
		long second = (millisecond - hours * (60 * 60 * 1000) - minutes
				* (60 * 1000)) / 1000; // 根据时间差来计算秒数
		long milliSecond = millisecond - hours * (60 * 60 * 1000) - minutes
				* (60 * 1000) - second * 1000; // 根据时间差来计算秒数
		if (milliSecond < 100) {
			milli = "0" + milliSecond;
		} else {
			milli = "" + milliSecond;
		}
		return hours + "�? " + minutes + "�?" + second + "�?" + milli + "毫秒";
		// return hours + ":�? " + minutes + ":�? " + second + ":�?" + milli +
		// ":毫秒";
	}

	// �?127.0.0.1形式的IP地址转换成十进制整数，这里没有进行任何错误处�?
